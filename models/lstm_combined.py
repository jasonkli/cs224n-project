...
class LSTMCombined(nn.Module):
    def __init__(self, file_path, cnn_feature_size=2048, lstm_input_size=1024, hidden_size_encoder=512, hidden_size_decoder=512, embed_size=256, att_projection_dim=8, device='cpu', dropout_rate=0.2, encoder='lstm'):
